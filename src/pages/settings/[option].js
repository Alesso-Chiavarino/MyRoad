            ...
            <section className='container mx-auto text-white'>
                <div className='flex justify-between items-center my-10'>
                    <div className='flex gap-2 w-fit items-center'>
                        <img src={`https://robohash.org/${user?.email}`} alt='user profile image' className={`cursor-pointer mx-auto object-cover border-[1px] border-gray-100/70' rounded-full h-11 w-11 z-40`} />
