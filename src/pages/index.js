      ...
      <header>
        <div className="container mx-auto grid grid-cols-2 items-center h-[70vh]">
          <div className="w-full flex flex-col gap-5">
            ...
            <Link href={'/dashboard'} className='text-white font-bold w-fit rounded-md px-4 flex items-center py-3 gap-2 bg-[#7148FC] hover:bg-[#7a51ff]'>Go to Dashboard <MdArrowForwardIos className="text-xl" /></Link>
          </div>
