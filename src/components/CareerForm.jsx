            ...
            <form action="" onSubmit={handleSubmit} className=" ">
                ...
                <div className="flex flex-col gap-10">
                    ...
                    <div className="grid grid-cols-2 gap-5 text-[#D6DEE7]">
                        <input type="text" name="name" placeholder="Type career name" onChange={handleCareer} className='bg-[#111111] border-[1px] border-[#B8BFC6] p-2 rounded-md w-full outline-none focus:border-[#7148FC] transition-all duration-300 placeholder:font-medium' />

                        <input type="text" name="description" placeholder="Type career description" onChange={handleCareer} className='bg-[#111111] border-[1px] border-[#B8BFC6] p-2 rounded-md w-full outline-none focus:border-[#7148FC] transition-all duration-300 placeholder:font-medium' />

                        <input type="text" name="image" placeholder="Attach image url" onChange={handleCareer} className='bg-[#111111] border-[1px] border-[#B8BFC6] p-2 rounded-md w-full outline-none focus:border-[#7148FC] transition-all duration-300 placeholder:font-medium' />

                        <input type="text" name="salary" placeholder="Type the cost" onChange={handleCareer} className='bg-[#111111] border-[1px] border-[#B8BFC6] p-2 rounded-md w-full outline-none focus:border-[#7148FC] transition-all duration-300 placeholder:font-medium' />
                    </div>
                ...
                <button className="bg-white font-bold w-full rounded-md py-2 mt-5 flex items-center justify-center"><IoIosCreate className='text-xl' />Create</button>
            </form>
        </div>
    )
}
