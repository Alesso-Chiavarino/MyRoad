        ...
        <div>
          ...
          <div className='flex flex-col gap-3 mt-2'>
            <form onSubmit={handleSubmit} className='flex gap-3' action="">
              <input defaultValue={userInfo?.email} onChange={handleEmail} type="email" name='email' className='border-[1px] border-gray-300 rounded-md px-4 py-2 text-gray-300 text-sm w-2/5 bg-transparent font-bold outline-none' placeholder='Enter your new email' />
